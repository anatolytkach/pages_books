...
!function(){function n(){try{if(window.matchMedia&&window.matchMedia("(hover: hover) and (pointer: fine)").matches)return}catch(a){}try{var b=document.documentElement,c=document.body,d=window.innerHeight||b&&b.clientHeight||c&&c.clientHeight||0,e={a:b&&b.style?b.style.overflow:"",b:c&&c.style?c.style.overflow:"",h:b&&b.style?b.style.height:"",m:c&&c.style?c.style.minHeight:""},f=null;try{f=document.createElement("div"),f.setAttribute("aria-hidden","true"),f.style.cssText="position:absolute;left:0;top:0;width:1px;height:2px;opacity:0;",c&&c.appendChild(f)}catch(g){}b&&b.style&&(b.style.overflow="auto",d&&(b.style.height=d+2+"px")),c&&c.style&&(c.style.overflow="auto",d&&(c.style.minHeight=d+2+"px"));var h=function(){try{window.scrollTo(0,1)}catch(i){}try{b&&(b.scrollTop=1)}catch(i){}try{c&&(c.scrollTop=1)}catch(i){}};h(),setTimeout(h,50),setTimeout(function(){try{f&&f.parentNode&&f.parentNode.removeChild(f)}catch(g){}try{b&&b.style&&(b.style.overflow=e.a,b.style.height=e.h)}catch(g){}try{c&&c.style&&(c.style.overflow=e.b,c.style.minHeight=e.m)}catch(g){}},250)}catch(g){}}function o(){var a=document.getElementById("addressBarToggle");a&&a.addEventListener("click",function(){n()})}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",o):o()}();
