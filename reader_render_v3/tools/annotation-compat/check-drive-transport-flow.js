...
import { buildProtectedSyncFileFromBundle, convertProtectedSyncFileToProtectedBundle } from "../../runtime/protected-sync-compat.js";
...
console.log(JSON.stringify({
  ok: downloadResult.compatibility.compatible,
  ...
  compatibility: downloadResult.compatibility,
