# Protected Bootstrap Ingestion v5

This is the isolated bootstrap ingestion surface for the `reader_render_v5`
target line.

Iteration 1 scope is intentionally narrow:

- write a minimal bootstrap manifest artifact
- validate that manifest shape
- keep the bootstrap artifact path completely inside `reader_render_v5`
...
- URL root used by the `v5` reader: `/reader_render_v5/artifacts/protected-bootstrap-books/<bookId>/`
...
```bash
npm --prefix reader_render_v5 run protected:bootstrap:build -- --input books/content/manual/1 --book-id 1 --title "Bootstrap Book" --output reader_render_v5/artifacts/protected-bootstrap-books/1
```

Validate example:

```bash
npm --prefix reader_render_v5 run protected:bootstrap:validate -- --input reader_render_v5/artifacts/protected-bootstrap-books/1
```
