    ...
    for (const run of block.runs) {
      ...
      if (!styleRegistry[token]) {
        styleRegistry[token] = {
          ...
          hyphens: (block.blockPresentation && block.blockPresentation.hyphens) || "manual",
          wordBreak: (block.blockPresentation && block.blockPresentation.wordBreak) || "normal",
          overflowWrap: (block.blockPresentation && block.blockPresentation.overflowWrap) || "normal",
