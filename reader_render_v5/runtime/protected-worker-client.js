import { ProtectedReaderRuntimeCore } from "./protected-worker-core.js?v=20260422-v5-heading-style-payload-1";
import {
...
class WorkerTransport {
  constructor() {
    this.worker = new Worker(new URL("./protected-reader.worker.js?v=20260422-v5-heading-style-payload-1", import.meta.url), { type: "module" });
